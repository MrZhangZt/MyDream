...
public class LicensePlateController {
    ...
    public String plate(){
        ...
        // 读取图片字节数组
        try {
            in = new FileInputStream("C:\\Users\\Administrator\\Desktop\\demo2\\src\\main\\resources\\templates\\img\\plate.PNG");
        ...
        try {
            ...
            result= util.httpPostWithForm("https://api.ai.qq.com/fcgi-bin/ocr/ocr_plateocr",params);
